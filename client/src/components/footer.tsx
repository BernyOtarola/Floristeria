    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-3">
              <a
                href={whatsappLink("¡Hola! Me gustaría hacer un pedido 🌸")}
                target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#catalogo" className="hover:text-white transition-colors">Envíos</a></li>
              <li>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p className="flex items-start">
                ...
                <span className="text-sm">
                  ...
                  <br />
                  {FLORISTERIA_CONFIG.location.city},{" "}
                  {FLORISTERIA_CONFIG.location.province}
                </span>
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {year} {FLORISTERIA_CONFIG.name}. Todos los derechos reservados.</p>
          <p className="text-sm mt-2">
            🌺 Flores frescas del corazón de {FLORISTERIA_CONFIG.location.city} 🌺
          </p>
        </div>
      </div>
    </footer>
