...
export default function AboutSection() {
  const waText =
    "¡Hola! Me gustaría consultar por arreglos florales 🌸";
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              {FLORISTERIA_CONFIG.description} Ubicados en el corazón de{" "}
              {FLORISTERIA_CONFIG.location.city}, nos especializamos en crear
              momentos únicos con flores frescas y arreglos personalizados que
              reflejan la belleza natural de nuestra región.
            </p>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Email: {FLORISTERIA_CONFIG.contact.email}
                  </p>
                </div>
              </div>
            </div>
