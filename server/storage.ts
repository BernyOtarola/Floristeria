import { 
  type Category, type Product, type CartItem, type Coupon, type Order, type Review,
  type InsertCategory, type InsertProduct, type InsertCartItem, type InsertCoupon, type InsertOrder, type InsertReview
} from "@shared/schema";
...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    const couponsData: InsertCoupon[] = [
      { code: "FLORES10", discount: "10.00", isActive: true },
